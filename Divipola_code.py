...
#   archivo = pd.read_excel(path)
#   return archivo

#df_prueba = leer_archivo("C:/Users/Lisa/Documents/Bases de Python/Bases Actualizables/5W_Colombia_-_RMRP_2022_Consolidado dos_25042022.xlsx")
